...
[![Tests](https://img.shields.io/badge/tests-1199%20passing-brightgreen.svg)]()
...
1199 GoogleTest unit tests across 12 test suites:
...
| Review Fixes (2026-05-29) | 25 | Minus-strand CDS/UTR boundary, HGVSg delins, filter all-transcripts, gene-constraint, SV strand/BND, HGVS inv/delins/ext, exon-intron strand |
| **Total** | **1199** | |
